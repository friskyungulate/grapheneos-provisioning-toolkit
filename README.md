...
5. Enable the FUTO F-Droid Repository in Neo Store's repository settings, then select "Sync & Start"
6. Install Tor Browser through Neo Store.
7. Open FUTO Keyboard and set it as the default keyboard.
8. Open Settings and delete all saved WiFi networks after all the steps above are complete.
